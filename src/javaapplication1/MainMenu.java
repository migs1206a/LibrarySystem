...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Hi, "+Act2_OOP.loggedInUsername);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
         int choice = JOptionPane.showConfirmDialog(this, "Are you sure you want to logout?", "LOGOUT MESSAGE", JOptionPane.YES_NO_OPTION);
    if (choice == JOptionPane.YES_OPTION) {
        new Act2_OOP().setVisible(true);
        this.setVisible(false);
        Act2_OOP.loggedInUsername = "";
